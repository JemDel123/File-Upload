...
<body>
    <div class="container mt-4">
        <div class="card">
            <div class="card-header"><h4><strong>Add New File</strong></h4></div>
            <div class="card-body">
                ...
                <form action="{{ route('files.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" placeholder="Input File Name" class="form-control" value="{{ old('name') }}" required>
                        @error("name")
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="detail" id="detail" placeholder="Description" class="form-control" rows="4" required>{{ old('detail') }}</textarea>
                        @error("detail")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="updload_file" id="updload_file" class="form-control">
                    </div>
